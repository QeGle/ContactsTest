...
import com.qegle.konturtestapp.ui.adapters.ContactsAdapter
...
class ListContactF : Fragment() {
	...
	override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
		return if (this.view != null) this.view!! else inflater.inflate(R.layout.f_contacts, container, false)
	}
	...
	override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
		...
		rvContacts.adapter = ContactsAdapter { contact ->
			findNavController().navigate(ListContactFDirections.toDetailContactF(contact))
		}
